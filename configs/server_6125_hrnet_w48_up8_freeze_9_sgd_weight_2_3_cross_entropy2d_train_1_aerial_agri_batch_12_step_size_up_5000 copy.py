...
LastEditTime: 2020-03-03 12:27:05
Description : 
'''
...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    # pseudo_label
                    pseudo_image_dir = r"/home/chenbangdong/cbd/LinHonghui/DrivenData_2020_SegBulid/SegBuild/exp/7919/image", pseudo_mask_dir = r"/home/chenbangdong/cbd/LinHonghui/DrivenData_2020_SegBulid/SegBuild/exp/7919/label",  
                    # extra_datasets --> List[]
